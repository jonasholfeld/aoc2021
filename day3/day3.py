...
for index in range(0, len(powerconsumption[0])):
    bits[index] = { 0: 0, 1: 0 }
...
for index in range(0, len(powerconsumption[0])):
    ...
    epsilonrate += str(0 if bits[index][0] < bits[index][1] else 1)
